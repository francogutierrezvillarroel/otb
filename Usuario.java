...
public class Usuario {
    ...
    private boolean reglectura;
    
    private boolean clientes;
    private boolean registroDeClientes;
    private boolean historialDeClientes;
    ...
    private boolean reportegeneral;
    ...
    public boolean isReglectura() {
        return reglectura;
    }
    public void setReglectura(boolean reglectura) {
        this.reglectura = reglectura;
    }
    ...
    public boolean isHistorialCliente() {
        return historialDeClientes;
    }
    public void setHistorialCliente(boolean historialDeClientes) {
        this.historialDeClientes = historialDeClientes;
    }
    ...
    public void setEmisionesDeOrdenes(boolean emisionesDeOrdenes) {
        //System.out.print("Ordenes en USUARIO:"+emisionesDeOrdenes+"\n");
    ...
    public boolean isReportegeneral() {
    ...
    public void setAlerta(boolean alertas) {
    ...
    public int grabar()
    {
        String sql = "INSERT INTO tblusuario (Usuario, passwd,"+
                     "Archivo,IniciarSesion,CerrarSesion,RegistroDeUsuario,SalirDeAplicacion,"+
                     "Clientes,RegistroDeClientes,"+
                     "Pagos,RegistroDePagos,"+"EmisionesOrdenes,"+
                     "Reportes,ReporteDeIngresos,ReporteDePagos,ReporteDeOrdenes,"+
                     "Herramientas,Calculadora,RespaldarBd,RestaurarBd,"+
                     "Ayuda,MostrarAyuda,AcercaDe,"+
                     "lectura,reglectura,HistorialDeClientes,cobros,cobrar,reportegeneral,alerta)"+
       "VALUES ('"+this.usuario+"','"+this.passwd+"',"+
                    this.archivo+","+this.iniciarSesion+","+this.cerrarSesion+","+this.registroDeUsuario+","+this.salirDeAplicacion+", "+
                    this.clientes+","+this.registroDeClientes+","+
                    this.pagos+","+this.registrosDePagos+","+this.emisionesDeOrdenes+","+
                    this.Reportes+","+this.reporteDeIngresos+","+this.reporteDePagos+","+this.reporteDeOrdenes+","+
                    this.herramientas+","+this.calculadora+","+this.respladarBd+","+this.restaurarBd+","+
                    this.ayuda+","+this.mostrarAyuda+","+this.acercade+","+
                    this.lectura+","+this.reglectura+","+this.historialDeClientes+","+this.cobros+","+this.cobrar+","+this.reportegeneral+","+this.alertas+")";
    ...
    public int actualizar()
    {
        String sql = "UPDATE tblusuario SET "+
                    ...
                    "reglectura = "+this.reglectura+","+
                    "HistorialDeClientes = "+this.historialDeClientes+","+
                    "cobros = "+this.cobros+","+
                    "cobrar = "+this.cobrar+","+
    ...
    public static ArrayList<Usuario> getUsuarios()
    {
        ...
        try{
            while(users.next())
            {
                ...
                usuario.setLectura(users.getBoolean(25));
                usuario.setReglectura(users.getBoolean(26));
                usuario.setHistorialCliente(users.getBoolean(27));
                usuario.setCobros(users.getBoolean(28));
                usuario.setCobrar(users.getBoolean(29));
                usuario.setReportegeneral(users.getBoolean(30));
                usuario.setAlerta(users.getBoolean(31));
        ...
        Usuario usuario = null;
           try{
            while(users.next())
            {
                ...
                usuario.setPasswd(users.getString(3));//contraseña
                usuario.setArchivo(users.getBoolean(4));//archivo
                usuario.setIniciarSesion(users.getBoolean(5));//IniSesion
                usuario.setCerrarSesion(users.getBoolean(6));//CerrarSesion
                usuario.setRegistroDeUsuario(users.getBoolean(7));//RegistroUsuario
                usuario.setSalirDeAplicacion(users.getBoolean(8));//SalirAplicacion
                usuario.setClientes(users.getBoolean(9));//Cleintes
                usuario.setRegistroDeClientes(users.getBoolean(10));//RegistroClientes
                usuario.setPagos(users.getBoolean(11));//Pagos
                usuario.setRegistrosDePagos(users.getBoolean(12));//RegsistroPagos
                usuario.setEmisionesDeOrdenes(users.getBoolean(13));
                usuario.setReportes(users.getBoolean(14));
                usuario.setReporteDeIngresos(users.getBoolean(15));
                usuario.setReporteDePagos(users.getBoolean(16));
                ...
                usuario.setAyuda(users.getBoolean(22));
                usuario.setMostrarAyuda(users.getBoolean(23));
                usuario.setAcercade(users.getBoolean(24));//AcercaDE
                usuario.setLectura(users.getBoolean(25));//LECTURA                
                usuario.setReglectura(users.getBoolean(26));//regLECTURA
                usuario.setHistorialCliente(users.getBoolean(27));//Historial
                usuario.setCobros(users.getBoolean(28));
                usuario.setCobrar(users.getBoolean(29));
                usuario.setReportegeneral(users.getBoolean(30));
                usuario.setAlerta(users.getBoolean(31));
